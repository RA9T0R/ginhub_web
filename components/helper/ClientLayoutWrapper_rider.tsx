...
const ClientLayoutWrapper_rider = ({ children }: { children: React.ReactNode }) => {
    ...
    if (!mounted) {
        return <div className="min-h-screen bg-BG_dark dark:bg-Dark_BG_dark opacity-0" />;
    }

    return (
        <div className="min-h-screen bg-BG_dark dark:bg-Dark_BG_dark flex flex-col font-space-grotesk">
            <Navbar_rider />
